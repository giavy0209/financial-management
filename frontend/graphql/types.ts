...
export type Query = {
  ...
  summary: ResultUnionSummarySingle;
...
export type ResultUnionSummarySingle = ErrorOutput | SummarySingle;
...
export type SummarySingle = BaseResponse & {
  __typename?: 'SummarySingle';
  data: Summary;
  message: Array<Scalars['String']['output']>;
  statusCode: HttpCode;
};
